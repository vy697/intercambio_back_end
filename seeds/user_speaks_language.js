...
exports.seed = function(knex, Promise) {
  ...
  .then(function() {
    return Promise.all([
      knex('user_speaks_language').insert({"id":1,"user_id":30,"language_id":1}),
      knex('user_speaks_language').insert({"id":2,"user_id":29,"language_id":2}),
      knex('user_speaks_language').insert({"id":3,"user_id":27,"language_id":3}),
      knex('user_speaks_language').insert({"id":4,"user_id":28,"language_id":4}),
      knex('user_speaks_language').insert({"id":5,"user_id":26,"language_id":5}),
      knex('user_speaks_language').insert({"id":6,"user_id":24,"language_id":6}),
      knex('user_speaks_language').insert({"id":7,"user_id":25,"language_id":7}),
      knex('user_speaks_language').insert({"id":8,"user_id":23,"language_id":8}),
      knex('user_speaks_language').insert({"id":9,"user_id":21,"language_id":1}),
      knex('user_speaks_language').insert({"id":10,"user_id":22,"language_id":2}),
