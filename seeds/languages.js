...
exports.seed = function(knex, Promise) {
  ...
  .then(function() {
    return Promise.all([
    knex('languages').insert({"id":1,"name":"French","level":"Intermediate"}),
    knex('languages').insert({"id":2,"name":"Portuguese","level":"Advanced"}),
    knex('languages').insert({"id":3,"name":"Vietnamese","level":"Advanced"}),
    knex('languages').insert({"id":4,"name":"Portuguese","level":"Beginner"}),
    knex('languages').insert({"id":5,"name":"Vietnamese","level":"Native"}),
    knex('languages').insert({"id":6,"name":"English","level":"Native"}),
    knex('languages').insert({"id":7,"name":"Portuguese","level":"Advanced"}),
    knex('languages').insert({"id":8,"name":"Spanish","level":"Intermediate"}),
