...
exports.seed = function(knex, Promise) {
  ...
  .then(function() {
    ...
    knex('language_translations').insert({"language_id": 5, "lang_preference":"en", "display_name": "Vietnamese"}),
    knex('language_translations').insert({"language_id": 6, "lang_preference":"en", "display_name": "German"}),
    ...
    knex('language_translations').insert({"language_id": 5, "lang_preference":"es", "display_name": "vietnamita"}),
    knex('language_translations').insert({"language_id": 6, "lang_preference":"es", "display_name": "alemán"}),
