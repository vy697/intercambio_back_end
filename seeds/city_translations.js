...
exports.seed = function(knex, Promise) {
  ...
  .then(function() {
    return Promise.all([
      ...
      knex('city_translations').insert({"city_id": 4, "lang_preference": "en", "display_name": "Berlin, Germany"}),
      ...
      knex('city_translations').insert({"city_id": 4, "lang_preference": "es", "display_name": "Berlín, Alemania"}),
